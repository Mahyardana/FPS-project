...
bool Colorshaderclass::Initialize(ID3D11Device *device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, "Colorvs.hlsl", "Colorps.hlsl");
	if (!result)
	{
		return false;
	}
...
bool Colorshaderclass::Render(ID3D11DeviceContext *deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DMATRIX viewMatrix, D3DMATRIX projectionMatrix)
{
	bool result;
