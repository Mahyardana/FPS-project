...
bool DebugWindowClass::Render(ID3D11DeviceContext* deviceContext, int screenwidth, int screenheight, int positionX, int positionY)
{
	bool result;


	// Re-build the dynamic vertex buffer for rendering to possibly a different location on the screen.
	result = UpdateBuffers(deviceContext, screenwidth, screenheight, positionX, positionY);
	if (!result)
	{
		return false;
	}
...
bool DebugWindowClass::UpdateBuffers(ID3D11DeviceContext* deviceContext, int screenwidth, int screenheight, int positionX, int positionY)
{
